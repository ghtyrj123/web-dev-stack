...
/*
    ...
    - CUBE(컬럼1, 컬럼2) : 컬럼1을 가지고 중간집계도 내고, 컬럼2를 가지고 중갑집계를 또 내는 함수
...
/*
    ...
    -여러 개의 쿼리문에서 조회하여고 하는 컬럼의 개수와 이름이 같아야
        집합 연산자를 사용할 수 있음!
        ...
        MINUS(차집합) : 선행 쿼리문의 결과값에서 후행 쿼리문의 결과값을 뺀 나머지 결과값을 추출
*/
...
-- 300만원 초과인 사원들의 사번, 사원명, 부서코드, 급여 조회
